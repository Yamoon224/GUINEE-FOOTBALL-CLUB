...
const clubMeta: Record<string, { nom: string; acronyme: string; logo: string; color: string }> = {
  jag: { nom: "Jaguar Académie Guinée", acronyme: "JAG", logo: "/images/jag-logo.jpg", color: "#D97706" },
  atletico: { nom: "Club Atlético de Colèah", acronyme: "Atlético", logo: "/images/atletico-logo.jpg", color: "#DC2626" },
};
